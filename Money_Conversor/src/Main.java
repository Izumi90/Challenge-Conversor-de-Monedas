...
import Service.ExRtAPI;
import Utils.JsonParser;
import Utils.ExRtSave;
...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String buildRequest = ExRtAPI.construirURL(fromCurrency, toCurrency);
            String respuestaExchange = ExRtAPI.consultarURL(buildRequest);
            ExRtAPI exchangeResponse = ExRtAPI.parseRate(respuestaExchange);
    ...
    private static void infoParseada(ExRtAPI info) {
    ...
    private static void mostrarResultadoConversion(ExRtAPI info, int monto) {
    ...
    private static void preguntarYGuardarArchivo(List<String> historial) {
        ...
        if (respuesta.equals("si")) {
            ExRtSave.guardarHistorial(historial);
        } else {
